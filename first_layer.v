	...
	always @(*) begin
		...
		if (enable) begin
			case (fr_fms_state)
				...
				RQ_WIN0: begin
					req_win = 1'b1;
					addr_win = (pixel_counter << 7) + (iteration_counter << 2);
				end
				ST_WIN0: begin
					req_win = 1'b0;
				...
				RQ_WIN1: begin
					req_win = 1'b1;
					addr_win = (pixel_counter << 7) + (iteration_counter << 2) + 17'd1;
				end
				ST_WIN1: begin
					req_win = 1'b0;
				...
				RQ_WIN2: begin
					req_win = 1'b1;
					addr_win = (pixel_counter << 7) + (iteration_counter << 2) + 17'd2;
				end
				ST_WIN2: begin
					req_win = 1'b0;
				...
				RQ_WIN3: begin
					req_win = 1'b1;
					addr_win = (pixel_counter << 7) + (iteration_counter << 2) + 17'd3;
				end
				ST_WIN3: begin
					req_win = 1'b0;
